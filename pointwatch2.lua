...
--Enhanced version with orange background bar to match EnemyBar2 aesthetic
...
-- If orange_bg.png doesn't exist, create a simple colored rectangle
-- You can create this file or the bar will just show as a colored rectangle
